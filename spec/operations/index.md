...
To declare conformance with this IG, a server should include the following URL in its own `CapabilityStatement.instantiates`: <a href="../CapabilityStatement-bulk-data.html">http://www.hl7.org/fhir/bulk-data/CapabilityStatement-bulk-data|1.0.1</a>