...
* outcome[0].url = "http://example.org/output/import_errors_1.ndjson"
* outcome[0].manifestUrl = "http://example.org/manifests/3556d214-c6e2-42e6-a7f7-89690f7a40bb_1"
* outcome[0].countSeverity[0].code = #information
* outcome[0].countSeverity[0].count = 0
* outcome[0].countSeverity[1].code = #error
* outcome[0].countSeverity[1].count = 100
* outcome[1].url = "http://example.org/output/validation_errors_2.ndjson"
* outcome[1].manifestUrl = "https://example.org/manifests/3556d214-c6e2-42e6-a7f7-89690f7a40bb_2"
* outcome[1].countSeverity[0].code = #information
* outcome[1].countSeverity[0].count = 98
* outcome[1].countSeverity[1].code = #error
* outcome[1].countSeverity[1].count = 2
