...
* Provider organization wants to update the vaccination status of a high risk cohort to support panel management activities based on data in a state immunization registry, and needs to match patients from its EHR system to those in the state immunization information system.
